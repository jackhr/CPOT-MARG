...
<body id="one-of-a-kind" class="imogen">
    <?php require_once __DIR__ . '/../../includes/nav.php'; ?>

    <section class="header">
        <div class="inner">
            <h1>Imogen</h1>
            <p>Imogen's portfolio of one-of-a-kind pieces reflects her singular eclectic response to varied sources of inspiration.</p>
